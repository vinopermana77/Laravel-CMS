                ...
                <div class="post post-single">
                    ...
                    <div class="post-meta">
                        <ul>
                            ...
                            <li>
                                <a href="blog-grid.html"><i class="ion-pricetags"></i> {{ $post->category->name }}</a>
                            </li>
                        </ul>
                    </div>
                    <div class="post-thumb">
                        <img class="img-fluid" src="{{ asset('storage/images/posts/'. $post->gallery->image) }}"
                    ...
                    <div class="post-comments">
                        ...
                        <ul class="media-list comments-list m-bot-50 clearlist">
                            ...
                            <li class="media">
                                <a class="pull-left" href="#!">
                                    <img class="media-object comment-avatar rounded-circle"
                                        src="{{ asset('assets/website/images/blog/avater-1.jpg') }}" alt="" width="50"
                                        height="50">
                                </a>
                                <div class="media-body">
                                    ...
                                    <div class="media">
                                        <a class="pull-left" href="#!">
                                            <img class="media-object comment-avatar rounded-circle"
                                                src="{{ asset('assets/website/images/blog/avater-2.jpg') }}" alt=""
                                                width="50" height="50">
                                        </a>
                                        <div class="media-body">
                                            <div class="comment-info">
                            ...
                            <li class="media">
                                <a class="pull-left" href="#!">
                                    <img class="media-object comment-avatar rounded-circle"
                                        src="{{ asset('assets/website/images/blog/avater-4.jpg') }}" alt="" width="50"
                                        height="50">
                                </a>
                                <div class="media-body">
                                    <div class="comment-info">
